...
static constexpr Speed JUMP_SPEED{{-0.00139}}; // -0.00126 from experiments -0.00140
static constexpr Speed TERMINAL_VELOCITY{{0.00214}}; // this should be quite accurate
static constexpr Acceleration GRAVITY{{0.000004490}}; // position grows down, gravity is positive 0.00000427
...
static constexpr std::chrono::milliseconds SCREEN_POST_CAPTURE_PROCESSING_TIME = 2ms;
...
static constexpr std::chrono::milliseconds SIMULATED_ARM_TAP_DELAY = 12ms;
